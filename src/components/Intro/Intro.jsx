    ...
    <div className="Intro" id="Intro">
      ...
      <div className="i-left">
        <div className="i-name">
          ...
          Au cours de mon expérience en tant que développeur web, j'ai travaillé avec plusieurs entreprises comme Connectors Technologies, BrokerLink.ae, GoMedia et OpenLink, IT-Pro Agency, 24-7 Digital Design et Jobid. Chez Connectors Technologies et It-Pro Agency, j'ai aidé à créer un nouveau site web en utilisant des outils modernes comme Laravel ,wordpress,PHP,React. Ensuite, chez GoMedia, j'ai développé des applications web et ajouté des fonctionnalités de commerce en ligne. Enfin, chez IT-Pro Agency, j'ai pris en charge plusieurs projets de A à Z, en veillant à ce que tout fonctionne bien et soit sécurisé. Ces expériences m'ont permis de renforcer mes compétences techniques et d'apprendre à mieux travailler en équipe,j'ai aussi le plaisir de vous parler de moi et de mon rôle en tant que formateur en développement web dans un centre de formation  renommé Its International Trainig Solution
